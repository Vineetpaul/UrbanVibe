    ...
    return (
        <div className='min-h-[550px] flex justify-center py-12 sm:py-0 '>
            <div className='container'>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 justify-center py-12">
                    <div data-aos='zoom-in'>
                        <img className='max-w-[400px] rounded-lg w-full h-auto mx-auto'
                    ...
                    <div className='flex flex-col gap-6 sm:pt-0 justify-center'>
                        ...
                        <p data-aos='fade-up'
                        className='text-sm tracking-wide text-gray-500 leading-5'>
                        ...
                        <div className='flex flex-col gap-4'>
                            <div data-aos='fade-up'>
                                ...
                                !duration-200 !transition-colors py-2 px-2'>
                                    <GrSecure className='h-12 w-12 rounded-full text-4xl 
                            ...
                            <div data-aos='fade-up'>
                                ...
                                !duration-200 !transition-colors py-2 px-2'>
                                    <IoFastFood className='h-12 w-12 rounded-full text-4xl 
                            ...
                            <div data-aos='fade-up'>
                                ...
                                !duration-200 !transition-colors py-2 px-2'>
                                    <GiFoodTruck className='h-12 w-12 rounded-full text-4xl 
